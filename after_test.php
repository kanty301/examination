<?php 
if(!isset($_SESSION['user'], $_SESSION['pretest_score'], $_SESSION['vdo'])) {//ถ้ายังไม่ได้ดูวีดีโอ
...
<div class="row">
    <div class="col s6 offset-s3">
        <?php
        if (isset($_SESSION['user'])) { // ถ้ากรอกข้อมูลแล้ว
            require "config/profile.php";
        }
        if (isset($_SESSION['aftertest_score'])) { // ถ้าเคยทำแบบทดสอบไปแล้ว
